...
public class ArrayMulti3 {
	...
	public static void main(String[] args) {
		...
		//printing names
		for(int i = 0; i < kidsName.length; i++) {
			System.out.println("Person " + i + " has " + kidsName[i].length + " kids.");
			for(int j = 0; j < kidsName[i].length; j++) {
